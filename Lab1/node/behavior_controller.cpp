...
public:
    BehaviorController() {
        ...
        // get topic names
        std::string scan_topic, odom_topic, imu_topic, joy_topic, keyboard_topic, brake_bool_topic, mux_topic,evader_drive_topic;
        ...
        n.getParam("evader_mux_idx",evader_mux_idx);
        // ***Add mux index for new planner here***
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        } else if (msg.buttons[evader_button_idx]) {
            toggle_mux(evader_mux_idx, "evader");
        }
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == joy_key_char) {
            ...
            // nav
            toggle_mux(nav_mux_idx, "Navigation");
        } else if (msg.data == evader_key_char){
            toggle_mux(evader_mux_idx, "evader");
        }
        // ***Add new else if statement here for new planning method***
